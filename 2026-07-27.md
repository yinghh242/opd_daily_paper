...
- full-paper reading failed for 2607.24720: curl: (28) Operation timed out after 90001 milliseconds with 1258247 out of 2902391 bytes received
- full-paper reading failed for 2607.24447: paper summary attempt 3/5 returncode=1; stdout="API call failed after 3 retries: Codex stream produced no bytes within 120s (TTFB threshold: 120s). Codex backend appears to be silently rejecting 'gpt-5.5' on chatgpt.com/backend-api/codex (no stream events, no error). This is a known backend-side pattern that has affected ChatGPT Plus accounts intermittently. Workaround: try `gpt-5.4` on the same OAuth profile, or `gpt-5.3-codex`, or switch to a different model/provider in your fallback chain. Some ChatGPT Codex accounts do not support `gpt-5.4-codex`. See hermes-agent#21444"; stderr='session_id: 20260730_100414_04b6aa'; paper summary attempt 4/5 returncode=1; stdout="API call failed after 3 retries: Codex stream produced no bytes within 120s (TTFB threshold: 120s). Codex backend appears to be silently rejecting 'gpt-5.5' on chatgpt.com/backend-api/codex (no stream events, no error). This is a known backend-side pattern that has affected ChatGPT Plus accounts intermittently. Workaround: try `gpt-5.4` on the same OAuth profile, or `gpt-5.3-codex`, or switch to a different model/provider in your fallback chain. Some ChatGPT Codex accounts do not support `gpt-5.4-codex`. See hermes-agent#21444"; stderr='session_id: 20260730_101231_42798b'; paper summary attempt 5/5 returncode=1; stdout="API call failed after 3 retries: Codex stream produced no bytes within 120s (TTFB threshold: 120s). Codex backend appears to be silently rejecting 'gpt-5.5' on chatgpt.com/backend-api/codex (no stream events, no error). This is a known backend-side pattern that has affected ChatGPT Plus accounts intermittently. Workaround: try `gpt-5.4` on the same OAuth profile, or `gpt-5.3-codex`, or switch to a different model/provider in your fallback chain. Some ChatGPT Codex accounts do not support `gpt-5.4-codex`. See hermes-agent#21444"; stderr='session_id: 20260730_102049_927233'
- full-paper reading failed for 2607.24731: curl: (28) Operation timed out after 90002 milliseconds with 1235353 out of 24258263 bytes received
- full-paper reading failed for 2607.24522: curl: (28) Operation timed out after 90000 milliseconds with 1545109 out of 5040379 bytes received
...
全文阅读/结构化总结生成失败：curl: (28) Operation timed out after 90001 milliseconds with 1258247 out of 2902391 bytes received
...
全文阅读/结构化总结生成失败：curl: (28) Operation timed out after 90002 milliseconds with 1235353 out of 24258263 bytes received
...
全文阅读/结构化总结生成失败：curl: (28) Operation timed out after 90000 milliseconds with 1545109 out of 5040379 bytes received
