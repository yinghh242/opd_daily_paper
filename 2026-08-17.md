...
- HF Daily Papers fetch failed for 2026-08-17: curl: (28) Connection timed out after 30001 milliseconds
- full-paper reading failed for 2608.16320: curl: (28) Operation timed out after 90000 milliseconds with 1753663 out of 8663244 bytes received
- full-paper reading failed for 2608.16333: paper summary attempt 3/5 returncode=1; stdout="API call failed after 3 retries: Codex stream produced no bytes within 120s (TTFB threshold: 120s). Codex backend appears to be silently rejecting 'gpt-5.5' on chatgpt.com/backend-api/codex (no stream events, no error). This is a known backend-side pattern that has affected ChatGPT Plus accounts intermittently. Workaround: try `gpt-5.4` on the same OAuth profile, or `gpt-5.3-codex`, or switch to a different model/provider in your fallback chain. Some ChatGPT Codex accounts do not support `gpt-5.4-codex`. See hermes-agent#21444"; stderr='session_id: 20260820_084907_ae7d19'; paper summary attempt 4/5 returncode=1; stdout="API call failed after 3 retries: Codex stream produced no bytes within 120s (TTFB threshold: 120s). Codex backend appears to be silently rejecting 'gpt-5.5' on chatgpt.com/backend-api/codex (no stream events, no error). This is a known backend-side pattern that has affected ChatGPT Plus accounts intermittently. Workaround: try `gpt-5.4` on the same OAuth profile, or `gpt-5.3-codex`, or switch to a different model/provider in your fallback chain. Some ChatGPT Codex accounts do not support `gpt-5.4-codex`. See hermes-agent#21444"; stderr='session_id: 20260820_085728_02f85b'; paper summary attempt 5/5 returncode=1; stdout="API call failed after 3 retries: Codex stream produced no bytes within 120s (TTFB threshold: 120s). Codex backend appears to be silently rejecting 'gpt-5.5' on chatgpt.com/backend-api/codex (no stream events, no error). This is a known backend-side pattern that has affected ChatGPT Plus accounts intermittently. Workaround: try `gpt-5.4` on the same OAuth profile, or `gpt-5.3-codex`, or switch to a different model/provider in your fallback chain. Some ChatGPT Codex accounts do not support `gpt-5.4-codex`. See hermes-agent#21444"; stderr='session_id: 20260820_090548_b505ed'
- full-paper reading failed for 2608.16386: paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260820_091329_f7d1b6'
- full-paper reading failed for 2608.16647: paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260820_091807_cb21a3'
- full-paper reading failed for 2608.16316: curl: (28) Operation timed out after 90000 milliseconds with 1853145 out of 2231190 bytes received
...
全文阅读/结构化总结生成失败：curl: (28) Operation timed out after 90000 milliseconds with 1753663 out of 8663244 bytes received
...
全文阅读/结构化总结生成失败：paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260820_091329_f7d1b6'
...
全文阅读/结构化总结生成失败：paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260820_091807_cb21a3'
...
全文阅读/结构化总结生成失败：curl: (28) Operation timed out after 90000 milliseconds with 1853145 out of 2231190 bytes received
