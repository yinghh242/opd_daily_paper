...
- HF Daily Papers fetch failed for 2026-09-14: curl: (28) Connection timed out after 30002 milliseconds
- full-paper reading failed for 2609.15404: paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260917_100543_45ab16'
- full-paper reading failed for 2609.15177: paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Codex stream produced no bytes within 120s (TTFB threshold: 120s). Codex backend appears to be silently rejecting 'gpt-5.5' on chatgpt.com/backend-api/codex (no stream events, no error). This is a known backend-side pattern that has affected ChatGPT Plus accounts intermittently. Workaround: try `gpt-5.4` on the same OAuth profile, or `gpt-5.3-codex`, or switch to a different model/provider in your fallback chain. Some ChatGPT Codex accounts do not support `gpt-5.4-codex`. See hermes-agent#21444"; stderr='session_id: 20260917_100615_d7ab0b'; paper summary attempt 2/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260917_101314_eabb82'
- full-paper reading failed for 2609.15313: paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260917_101344_36cb28'
- full-paper reading failed for 2609.15296: paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260917_101425_1c0336'
...
全文阅读/结构化总结生成失败：paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260917_100543_45ab16'
...
全文阅读/结构化总结生成失败：paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260917_101344_36cb28'
...
全文阅读/结构化总结生成失败：paper summary attempt 1/5 returncode=1; stdout="API call failed after 3 retries: Hermes can't reach the model provider. You may be offline. Check your internet connection and try again."; stderr='session_id: 20260917_101425_1c0336'
